...
if __name__ == "__main__":
    ...
    argParser.add_argument("-i", "--input", help="sft data name, those in corpus/")
    argParser.add_argument("-m", "--model", help="model name, e.g. mistral")
    argParser.add_argument("-p", "--parent_directory", default="./corpus/", help="parent directory") # other_checkpoint/
    ...
    dataset = load_dataset("json", data_files="corpus/" + input + ".jsonl", split="train")
    # print(len(dataset))
