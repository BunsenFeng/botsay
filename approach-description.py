...
if __name__ == "__main__":
    ...
    for id in tqdm(test_ids):
        ...
        prompt =  "The following task focuses on evaluating whether a Twitter user is a bot or human with the help of the user's self-written description. You should output the label first and explanation after.\n\n"
    ...
    if prob == "True":
        to_save["probs"] = probs
        with open("probs/description_" + dataset + "_" + model_name + "_" + str(num) + "_" + str(datetime.now()) + ".json", "w") as f:
